...
@ConfigurationParameter(key= FILTER_TAGS_PROPERTY_NAME,value = "@DataExist")
...
@ConfigurationParameter(key= PARALLEL_CONFIG_FIXED_PARALLELISM_PROPERTY_NAME,value="3")  // no.of threads to be created for a feature
